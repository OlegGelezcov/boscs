...
public class StoreListener : MonoBehaviour, IStoreListener
{
    ...
    private static string _productNameAppleSubscription = "com.unity3d.subscription.new";

    // Google Play Store-specific product identifier subscription product.
    private static string _productNameGooglePlaySubscription = "com.unity3d.subscription.original";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(kProductIDSubscription, ProductType.Subscription, new IDs(){
                { _productNameAppleSubscription, AppleAppStore.Name },
                { _productNameGooglePlaySubscription, GooglePlay.Name },
            });
