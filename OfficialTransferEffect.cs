namespace Bos.UI {
    ...
    public class OfficialTransferEffect : GameBehaviour {
        ...
        private IEnumerator ShowMoveTextFailImpl(TransferCashInfo info) {
            ...
            text.text = $"-{BosUtils.GetCurrencyString(info.TaxValue.ToCurrencyNumber(), "", "")}";
        ...
        private IEnumerator ShowMoveTextImpl(TransferCashInfo info) {
            yield return new WaitForSeconds(interval);
            ...
            Text text = textInstance.GetComponent<Text>();
            text.text = $"+{BosUtils.GetCurrencyString(info.RemainValue.ToCurrencyNumber(), "", "")}";
            //text.SetAllDirty();
